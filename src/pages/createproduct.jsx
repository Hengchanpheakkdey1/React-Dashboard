...
import { Package, Tag, DollarSign, Database, Upload, Sparkles } from 'lucide-react'
        ...
        <div className="p-4 bg-gray-50 min-h-full">
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h1 className="text-sm font-bold text-gray-900 m-0">Create New Product</h1>
                        <p className="text-[10px] text-gray-500 mt-0.5">Add a new item to your inventory catalog.</p>
                    </div>
                </div>
