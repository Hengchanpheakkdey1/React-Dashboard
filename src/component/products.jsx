...
import {
    ...
    TrendingUp, AlertTriangle, XCircle, Pencil, Trash2
} from 'lucide-react'

import ProductModal from './productsDetails'
        ...
        <div className="p-4 bg-gray-50 min-h-full">
            <div >
                ...
                <div className="flex items-center justify-between mb-3">
                    <div>
                        <h1 className="text-sm font-bold text-gray-900 m-0">Products Management</h1>
                        <p className="text-[10px] text-gray-500 mt-0.5">Manage your inventory, prices, and stock levels.</p>
                    </div>
                    <Link
                        to="/product/create"
                ...
                <div className="grid grid-cols-4 gap-3 mb-3">
                    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 flex items-center gap-2.5">
                        ...
                        <div>
                            <p className="text-[10px] text-gray-500 font-medium m-0">Total Products</p>
                            <p className="text-lg font-bold text-gray-900 m-0 leading-tight">1234</p>
                        </div>
                    </div>
                    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 flex items-center gap-2.5">
                        ...
                        <div>
                            <p className="text-[10px] text-gray-500 font-medium m-0">Total Stock</p>
                            <p className="text-lg font-bold text-gray-900 m-0 leading-tight">780</p>
                        </div>
                    </div>
                    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 flex items-center gap-2.5">
                        ...
                        <div>
                            <p className="text-[10px] text-gray-500 font-medium m-0">Low Stock</p>
                            <p className="text-lg font-bold text-gray-900 m-0 leading-tight">666</p>
                        </div>
                    </div>
                    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 flex items-center gap-2.5">
                        ...
                        <div>
                            <p className="text-[10px] text-gray-500 font-medium m-0">Out of Stock</p>
                            <p className="text-lg font-bold text-gray-900 m-0 leading-tight">100</p>
                        </div>
                    </div>
                </div>
                    ...
                    <table className="w-full border-collapse table-fixed">
                        <thead>
                            <tr className="border-b border-gray-100">
                                <th className="text-left text-[10px] font-semibold text-gray-400 uppercase tracking-wider px-3 py-2 w-[45%]">Product</th>
                                <th className="text-left text-[10px] font-semibold text-gray-400 uppercase tracking-wider px-3 py-2 w-[25%]">Category</th>
                                <th className="text-left text-[10px] font-semibold text-gray-400 uppercase tracking-wider px-3 py-2 w-[18%]">Price</th>
                                <th className="text-right text-[10px] font-semibold text-gray-400 uppercase tracking-wider px-3 py-2 w-[12%]">Actions</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-50">
                            {loading ? (
                                <tr>
                                    <td colSpan={4} className="text-center py-10 text-gray-400 text-xs">Loading...</td>
                                </tr>
                            ) : filtered.length === 0 ? (
                                <tr>
                                    <td colSpan={4} className="text-center py-10 text-gray-400 text-xs">No products found.</td>
                                </tr>
                                ...
                                <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-3 py-2">
                                        ...
                                        >
                                            <img
                                                src={product.images?.[0] || 'https://placehold.co/32x32'}
                                                alt={product.title}
                                                onError={e => { e.target.src = 'https://placehold.co/32x32/f3f4f6/9ca3af' }}
